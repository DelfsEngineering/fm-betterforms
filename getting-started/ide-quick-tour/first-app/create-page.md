...
When you run a [**Scoped Hook**](../3.-understanding-core-betterforms-concepts/3.1-introduction-to-hooks-and-where-to-find-them-in-the-ide.md#scoped-hooks) (a FileMaker script tied to this page), the current Data Model is passed with the request, allowing you to process and save the data back to your FileMaker database.
...
2. **Initial Page Settings:**
   ...
   * **Scoped Hook Set Name:** You'll need to set a [Scoped Hook Set Name](../3.-understanding-core-betterforms-concepts/3.1-introduction-to-hooks-and-where-to-find-them-in-the-ide.md#how-to-name-hooks) for the page. For this first page, something simple like "page1" or "myFirstPageHooks" will work. This name corresponds to a group of FileMaker scripts that will handle data operations for this specific page.
