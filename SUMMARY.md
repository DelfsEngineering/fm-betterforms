...
* [APIs & Services](reference/apis-and-services/README.md)
  * [Messaging](reference/apis-and-services/messaging/README.md)
    * [Adding users to channels](reference/apis-and-services/messaging/adding-users-to-channels.md)
    * [Removing users from channels](reference/apis-and-services/messaging/removing-users-from-channels.md)
    * [Sending messages](reference/apis-and-services/messaging/sending-messages.md)
    * [Get connected users](reference/apis-and-services/messaging/get-all-users-connected.md)
    * [Get active channels](reference/apis-and-services/messaging/get-active-channels.md)
  * [BF Server Proxy](reference/apis-and-services/server-proxy.md)
  * [BetterForms Error Pages API](reference/apis-and-services/error-pages-api.md)
  * [BF Streaming Proxy](reference/apis-and-services/streaming-proxy.md)
    * [BF Streaming API (Chat)](reference/apis-and-services/bf-streaming-api-chat.md)
    * [BF Streaming API (Assistants)](reference/apis-and-services/bf-streaming-assistants-api.md)
    * [BF Streaming API (LLM Query)](reference/apis-and-services/bf-streaming-api-llm-query.md)
* [Guides & Integrations](reference/guides-and-integrations/README.md)
...
* [Development & Best Practices](reference/development-and-best-practices/README.md)
