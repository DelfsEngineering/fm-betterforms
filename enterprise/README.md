...
**Optional** (not included with Klai Enterprise docker image):
...
| FM\_GATEWAY                | XML or DAPI - gateway to be used to communicate with Klai Enterprise Helper file (defaults to XML if no value is set) | No       |
